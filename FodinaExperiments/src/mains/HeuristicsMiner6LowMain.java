...
public class HeuristicsMiner6LowMain {
	public static final String basePath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\logs\\";
	public static final String outputPath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\models\\hm6low\\";
	public static final String experimentResultPath = outputPath+"heuristicsminer6low.csv";
	
	public static void main(String[] args) {
		NikeFS2VirtualFileSystem.instance().setSwapFileSize(250000000);
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.HeuristicsMiner6LowExperiment";
				config[3] = outputPath;
