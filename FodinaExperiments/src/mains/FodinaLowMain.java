...
public class FodinaLowMain {
	public static final String basePath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\logs\\";
	public static final String outputPath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\models\\fodinalow\\";
	public static final String experimentResultPath = outputPath+"fodinalow-rep.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.FodinaLowExperiment";
				config[3] = outputPath;
