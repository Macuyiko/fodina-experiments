...
public class FlexibleHeuristicsMiner6LowMain {
	public static final String basePath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\logs\\";
	public static final String outputPath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\models\\fhm6low\\";
	public static final String experimentResultPath = outputPath+"flexibleheuristicsminer6low.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.FlexibleHeuristicsMiner6LowExperiment";
				config[3] = outputPath;
