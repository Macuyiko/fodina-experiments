...
public class FodinaLowExperiment extends AbstractLogModelExperiment {
	...
	public void runExperiment(XLog log, Object model, String[] configuration, ResultsTable results) {
		...
		settings.dependencyThreshold = 0.10;
		settings.l1lThreshold = 0.10;
		settings.l2lThreshold = 0.10;
