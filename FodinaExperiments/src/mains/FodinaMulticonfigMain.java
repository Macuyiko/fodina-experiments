...
public class FodinaMulticonfigMain {
	...
	public static final String experimentResultPath = outputPath+"fodinamulticonfig.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.FodinaMulticonfigExperiment";
				config[3] = outputPath;
