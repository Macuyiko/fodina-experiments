...
public class HeuristicsMiner6LowExperiment extends AbstractLogModelExperiment {
	...
	public void runExperiment(XLog log, Object model, String[] configuration,
		...
		HeuristicsMiner miner = new HeuristicsMiner(new FakePluginContext(), log, settings);
