...
public class FodinaMain {
	public static final String basePath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\logs\\";
	public static final String outputPath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\models\\fodina\\";
	public static final String experimentResultPath = outputPath+"fodina-rep.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.FodinaExperiment";
				config[3] = outputPath;
