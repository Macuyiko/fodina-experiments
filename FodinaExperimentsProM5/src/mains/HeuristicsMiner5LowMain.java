...
public class HeuristicsMiner5LowMain {
	...
	public static final String experimentResultPath = outputPath+"heuristicsminer5low.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.HeuristicsMiner5LowExperiment";
				config[3] = outputPath;
