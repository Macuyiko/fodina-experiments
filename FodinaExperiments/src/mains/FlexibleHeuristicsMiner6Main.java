...
public class FlexibleHeuristicsMiner6Main {
	public static final String basePath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\logs\\";
	public static final String outputPath = "C:\\Users\\n11093\\Documents\\Papers Seppe\\Fodina (IS)\\experiment\\models\\fhm6\\";
	public static final String experimentResultPath = outputPath+"flexibleheuristicsminer6.csv";
	...
	public static void main(String[] args) {
		...
		for (File dirFile : baseFile.listFiles()) {
			...
			for (File dataFile : dirFile.listFiles()) {
				...
				config[1] = null;
				config[2] = "experiments.FlexibleHeuristicsMiner6Experiment";
				config[3] = outputPath;
